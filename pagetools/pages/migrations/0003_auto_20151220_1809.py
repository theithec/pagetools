...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            ...
            options={'verbose_name': 'Form field', 'verbose_name_plural': 'Additional form fields'},
        ),
        migrations.AddField(
            model_name='page',
        ...
        migrations.AlterField(
            model_name='pagedynformfield',
            name='name',
            field=models.CharField(help_text='The visible name of the field', verbose_name='Value', max_length=512),
        ),
        migrations.AlterField(
            model_name='pagedynformfield',
            name='required',
            field=models.BooleanField(help_text='Is the field required?', verbose_name='required', default=False),
        ),
    ]
