        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "included_form",
                    models.CharField(
                        max_length=255, verbose_name="Included form", blank=True
                    ),
                ),
                (
                    "login_required",
                    models.BooleanField(verbose_name="Login required", default=False),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "help_text",
                    models.CharField(
                        max_length=512, verbose_name="Helptext", blank=True
                    ),
                ),
                (
                    "initial",
                    models.CharField(
                        max_length=512, verbose_name="Default", blank=True
                    ),
                ),
                (
                    "form_containing_model",
                    models.ForeignKey(
