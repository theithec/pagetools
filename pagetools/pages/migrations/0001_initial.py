    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', model_utils.fields.StatusField(max_length=100, verbose_name='status', default='draft',
                                                          choices=[('draft', 'draft'), ('published', 'published')], no_check_for_status=True)),
                ('status_changed', model_utils.fields.MonitorField(
                    verbose_name='status changed', default=django.utils.timezone.now, monitor='status')),
                ('lang', models.CharField(max_length=20, blank=True, verbose_name='language', choices=settings.LANGUAGES)),
                ('title', models.CharField(max_length=255, verbose_name='Title')),
                ('slug', models.SlugField(max_length=255, verbose_name='Slug')),
                ('description',
                 models.CharField(max_length=139,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_containing_model', models.ForeignKey(
                    related_name='dynformfields', to='pages.Page', on_delete=models.CASCADE)),
            ],
            options={
