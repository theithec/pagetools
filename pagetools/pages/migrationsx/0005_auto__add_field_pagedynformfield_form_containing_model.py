...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pages_pagedynformfield', 'form_containing_model',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('pages_pagedynformfield', 'form_containing_model_id')
    ...
    models = {
        ...
        'pages.pagedynformfield': {
            'Meta': {'ordering': "['position']", 'object_name': 'PageDynFormField'},
            'field_type': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'form_containing_model': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dynformfields'", 'to': "orm['pages.Page']"}),
