...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('pages_page', 'slug', self.gf('pagetools.core.unislug.models.UnicodeSlugField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Page.slug'
        db.alter_column('pages_page', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))
