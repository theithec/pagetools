...
class MenuDataTestCase(TransactionTestCase):
    ...
    def setUp(self):
        ...
        self.page1 = Page.objects.create(title='P1', slug='start',
                                         status=STATUS_PUBLISHED, included_form="Contactform")
        ...
        self.cpm1 = ConcretePublishableLangModel.objects.create(
